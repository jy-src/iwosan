...
const ChartContent = () => {
	return (
		<div className="w-full flex items-center gap-x-5 mb-10 ">
          ...
          <li className='flex items-center gap-x-1'>
			...
			<div className="basis-2/6 h-[240px] border-[1px] border-vmc-700 rounded-[15px] dark:border-[#3D3D3D] pt-[14px]">
				{" "}
				...
				<div className=" w-full h-[150px] ">
					<img src="/curve.png" alt="Png" className="w-full h-[147px]" />
				</div>
			</div>
		</div>
	);
